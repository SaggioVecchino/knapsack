export default {
    UKP(
        ...
        function ConvertBinaryToGen(bit, sizeOfGen) {
            // console.log(`ConvertBinaryToGen(${bit}, ${sizeOfGen}`);
        ...
        function ConvertStringToBinary(binary) {
            // console.log(`ConvertStringToBinary(${binary})`);
            let result = 0;
            let k = 0;
        ...
        function CuttingGen(chromosome, end, start = 0) {
            // console.log(`CuttingGen(${chromosome}, ${end}, ${start})`);
            ...
            // console.log(
            //   `**********  result:${result}, resultjoin:${result.join(" ")}  **********`
            // );
            return result.join(" ");
        }
        ...
        function CalculateWeight(chromosome) {
            ...
            let totalWeight = 0;
            for (let i = 0; i < gens.length; i++) {
                // if (gens[i] == null) console.log("CalculateWeight", gens[i]);
        ...
        function CalculateFitness(chromosome) {
            ...
            let totalFitness = 0;
            for (let i = 0; i < gens.length; i++) {
                // if (gens[i] == null) console.log("CalculateFitness", gens[i]);
        ...
        function InitPopulation() {
            ...
            while (i < PopulationSize) {
                ...
                let capacityLeft = W;
                for (
                    let h = 0; h < CombinationBitOfItem.length; h++
                ) {
                    ...
                    if (capacityLeft < chromosomesWeight) //We can add the chromosome
                        continue
